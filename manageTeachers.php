    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 mt-2 text-center">
                <h1 class="text-primary fw-bold">Manage All Teachers</h1>
            </div>
            ...
            $user_rs = Database::search("SELECT * FROM teacher");
            ...
            $view_user_rs = Database::search("SELECT * FROM `teacher` LIMIT " . $results_per_page . " OFFSET " . $page_first_result . " ");
            ...
            ?>
                ...
                <div class="col-12 mb-3">
                    <div class="row">
                        ...
                        $image_rs = Database::search("SELECT * FROM `teacher_profile` WHERE `teacher_email`='" . $user_data["Email"] . "'");
                        ...
                        <div class="col-4 col-lg-2 bg-white py-2 d-grid">
                            ...
                            if ($s == "1") {
                            ?>
                                <button class="btn btn-danger" onclick="teacherBlock('<?php echo $user_data['Email']; ?>');">Block</button>
                            <?php
                            } else {
                            ?>
                                <button class="btn btn-success" onclick="teacherBlock('<?php echo $user_data['Email']; ?>');">Unblock</button>
                            <?php
                            }
