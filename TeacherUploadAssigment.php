    ...
    <body class="bg-dark text-white">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 col-lg-6 offset-lg-3 rounded-3" style="background-color: rgba(255, 255, 255, 0.3);">
                    <div class="row">
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <input type="text" class="form-control" id="assigment">
                        </div>
                        ...
                        <div class="col-12 mt-1 mb-4 d-grid">
                            <button class="btn btn-primary" onclick="AssignmentUpload();">Upload</button>
                        </div>
                ...
                <div class="col-12 mt-5 mb-5 text-center">
                    <div class="row">
                        <h1 class="text-primary">Uploaded Assignment</h1>
                    </div>
                </div>

                <?php

                $assimhmet = Database::search("SELECT * FROM assignment WHERE teacher_Email = '" . $_SESSION["teacher"]["Email"] . "' ");
