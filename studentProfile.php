...
?>
    ...
    <head>
        <title>ONLINE PORTAL | Student Profile</title>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="d-flex flex-column align-items-center py-3 p-2">
                        ...
                        $profileImg = Database::search("SELECT * FROM `student_profile` WHERE `student_Email` = '" . $_SESSION["student"]["Email"] . "'");
                ...
                <div class="col-md-4">
                    <div class="d-flex flex-column align-items-md-start align-items-center py-md-5 p-md-3">
                        <span class="fw-bold offset-md-0"> <?php echo $_SESSION["student"]["Name"] ?></span>
                        <span class="text-black-50 offset-md-0"><?php echo $_SESSION["student"]["Email"] ?></span>
                        <input type="file" class="d-none" id="profileimg" accept="img/*">
                        <label class="btn btn-primary mt-3" for="profileimg" onclick="StudentChangeImg();">Update Profile Image</label>
                    </div>
                </div>
            </div>
                    ...
                    <div class="py-5 p-3">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input class="form-control" id="username" placeholder="Enter Your Username" id="name" type="text" value="<?php echo $_SESSION["student"]["Name"]; ?>" />
                            </div>

                            <div class="col-md-12 mb-3">
                                <label class="form-label">Mobile No.</label>
                                <input class="form-control" id="mobile" placeholder="Enter Your Mobile Number" type="text" value="<?php echo $_SESSION["student"]["Mobile"]; ?>" />
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <input class="form-control" placeholder="Password" type="password" id="password" readonly value="<?php echo $_SESSION["student"]["password"]; ?>" />
                                    </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input class="form-control" placeholder="Enter Your Email Address" type="text" readonly value="<?php echo $_SESSION["student"]["Email"]; ?>" />
                            </div>

                            <?php

                            $usreemail = $_SESSION["student"]["Email"];
                            $address = Database::search("SELECT * FROM `student_address` WHERE `student_email` = '" . $usreemail . "' ");
                            $n = $address->num_rows;
                            ...
                            ?>
                                ...
                                <div class="mt-3 text-center">
                                    <button class="btn btn-primary" onclick="Studentupdateprofile();">Update Profile</button>
                                </div>
