...
<head>
    <title>Admin | Manage Academic officers</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 mt-2 text-center">
                <h1 class="text-primary fw-bold">Manage All Academic officers</h1>
            </div>
            ...
            <div class="col-12 mt-3 mb-3">
                <div class="row">
                    ...
                    <div class="col-3 col-lg-2 bg-primary py-2">
                        <span class="fs-6 fw-bold text-white">Teacher Name</span>
                    </div>
            ...
            $user_rs = Database::search("SELECT * FROM academicofficer");
            ...
            $view_user_rs = Database::search("SELECT * FROM `academicofficer` LIMIT " . $results_per_page . " OFFSET " . $page_first_result . " ");
            ...
            ?>
                ...
                <div class="col-12 mb-3">
                    <div class="row">
                        ...
                        $image_rs = Database::search("SELECT * FROM `academic_profile` WHERE `email_id`='" . $user_data["Email"] . "'");
                        ...
                        <div class="col-4 col-lg-2 bg-white py-2 d-grid">
                            ...
                            if ($s == "1") {
                            ?>
                                <button class="btn btn-danger" onclick="academicBlock('<?php echo $user_data['Email']; ?>');">Block</button>
                            <?php
                            } else {
                            ?>
                                <button class="btn btn-success" onclick="academicBlock('<?php echo $user_data['Email']; ?>');">Unblock</button>
                            <?php
                            }
