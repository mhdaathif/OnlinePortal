...
?>
    ...
    <head>
        <title>ONLINE PORTAL | Teacher Profile</title>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="d-flex flex-column align-items-center py-3 p-2">
                        ...
                        $profileImg = Database::search("SELECT * FROM `teacher_profile` WHERE `teacher_email` = '" . $_SESSION["teacher"]["Email"] . "'");
                ...
                <div class="col-md-4">
                    <div class="d-flex flex-column align-items-md-start align-items-center py-md-5 p-md-3">
                        <span class="fw-bold offset-md-0"> <?php echo $_SESSION["teacher"]["Name"] ?></span>
                        <span class="text-black-50 offset-md-0"><?php echo $_SESSION["teacher"]["Email"] ?></span>
                    ...
                    <div class="py-5 p-3">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input class="form-control" id="username" placeholder="Enter Your Username" id="name" type="text" value="<?php echo $_SESSION["teacher"]["Name"]; ?>" />
                            </div>

                            <div class="col-md-12 mb-3">
                                <label class="form-label">Mobile No.</label>
                                <input class="form-control" id="mobile" placeholder="Enter Your Mobile Number" type="text" value="<?php echo $_SESSION["teacher"]["Mobile"]; ?>" />
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <input class="form-control" placeholder="Password" type="password" id="password" readonly value="<?php echo $_SESSION["teacher"]["password"]; ?>" />
                                    </div>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input class="form-control" placeholder="Enter Your Email Address" type="text" readonly value="<?php echo $_SESSION["teacher"]["Email"]; ?>" />
                            </div>

                            <?php

                            $usreemail = $_SESSION["teacher"]["Email"];
                            $address = Database::search("SELECT * FROM `teacher_adderss` WHERE `teacher_email` = '" . $usreemail . "' ");
                            $n = $address->num_rows;
                            ...
                            ?>
                                ...
                                <div class="mt-3 text-center">
                                    <button class="btn btn-primary" onclick="Teacherupdateprofile();">Update Profile</button>
                                </div>
